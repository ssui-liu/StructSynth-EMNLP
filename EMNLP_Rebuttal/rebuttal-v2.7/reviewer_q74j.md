...
Before the itemized responses, we would like to clarify one factual point regarding the Reproducibility / Datasets / Software assessments (1/1/1). An anonymized implementation and accompanying instructions were included in the original submission (Appendix A, l.855–859); we detail the additional replication assets in the checklist below (2/2).
...
*(gpt-5-mini, 1,000 synthetic rows per run)* (AUC / R² × 100)
