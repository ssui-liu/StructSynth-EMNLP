...
This section provides an extended discussion of the related work summarized in Section~\ref{sec:related_works}, offering additional technical details on representative methods in each line of research.
...
Algorithm~\ref{alg:structsynth} provides the complete pseudocode for the \textsf{StructSynth} framework, integrating both the dependency structure discovery and the structure-guided synthesis stages.
