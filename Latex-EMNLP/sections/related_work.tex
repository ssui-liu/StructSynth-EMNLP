...
Prompt-based methods avoid parameter updates: CuratedLLM (CLLM)~\cite{cllm2024} selects curated in-context examples to guide generation, yet does not explicitly model inter-feature dependency structure; TabGen-ICL~\cite{fang-etal-2025-tabgen} iteratively refines in-context selection to align the generated distribution with the real one.
