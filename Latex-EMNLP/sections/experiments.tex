...
Following previous methods~\cite{borisov2023language, cllm2024}, we evaluate the quality of synthetic data using three different metrics, with detailed definitions provided in Appendix~\ref{app:metrics}:
